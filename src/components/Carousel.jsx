...
export default function Carousel() {
    ...
    return (
    <>
        <div className='relative items-center justify-evenly flex-col xl:flex-row my-[2vw] lg:rounded-lg xl:h-[30vh] hidden sm:flex shadow-[0px_22px_70px_4px_rgba(0,0,0,0.56)] h-[40vh] sm:mx-0 lg:mx-24' id="colorCarousel" style={gradientStyle}>
