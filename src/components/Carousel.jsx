...
export default function Carousel() {
    ...
    return (
    <>
        <div className="hidden sm:flex h-[25vh] md:h-[30vh] w-fill rounded-md items-end mt-6 relative mx-12" id="colorCarousel" style={gradientStyle}>
            ...
            <div className='flex-col w-[40%] text-white h-full justify-center items-center pl-[5%] flex'>
