            ...
            <div className="bg-white min-h-screen w-1/2 flex justify-center items-center">
              <div className="flex flex-col">
                ...
                <div className="flex flex-col items-center">
                        ...
                        <Anchor to="/auth/signup/register" className="mt-6 ">You don't have an account yet? <span className="cursor-pointer text-sm text-fuchsia-400 font-bold">Sign up</span></Anchor>
